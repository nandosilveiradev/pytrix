...
========================================
FILE: ./pytrix_docker_compose.yml
========================================
networks:
  pytrix_network:
    name: pytrix_network
...
services:
  # Ambiente de Desenvolvimento (Apenas o core do Pytrix)
  pytrix:
    build:
      context: .
      dockerfile: pytrix_docker/Dockerfile.dev
  ...
  # Servidor de Arquivos Estáticos (Nginx)
  pytrix_web_static:
    image: nginx:alpine
